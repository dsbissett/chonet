<%@ Page Language="C#"  MasterPageFile="~/Adm/Admin.master" AutoEventWireup="true" CodeFile="ThaiNguyenConfig.aspx.cs" Inherits="Adm_ThaiNguyenConfig" Title="Cấu hình khu vực Thái Nguyên"%>
...
function ChangeProduct(pid)
{
    ...
    {
        OpenDialogWindow('Thay đổi sản phẩm',906,600,'page','SelectProduct.aspx?rid=<%=intKhuVucID %>&pid=' + pid);
    }
}
function ChangeCat()
{
