...
{
    OpenDialogWindow('Chọn sản phẩm mẫu',985,840,'page','SelectTemplate.aspx'); 
}

function Add(){                              
        OpenDialogWindow('Thêm sản phẩm',985,1240,'page','AddProduct.aspx');    
}

function Edit(obj){   
        var cell=igtbl_getCellById(obj.parentElement.id);
        var id=cell.Row.getCellFromKey('SanPhamID').getValue();                   
        OpenDialogWindow('Sửa thông tin sản phẩm',995,1240,'page','AddProduct.aspx?id=' + id);// + '&rand=' + rand_no);    
}
...
<igmisc:WebAsyncRefreshPanel ID="pnlSanPham" runat="server" Height="100%" Width="100%"
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td style="padding-top: 10px">
                <table width="100%">
                    <tr>
                        <td>
                            <input id="btnAddTop" class="short-button" type="button" value="Thêm mới" onclick="Add();"
                                runat="server" style="width: 106px" />
                            &nbsp; &nbsp; &nbsp; &nbsp;
                            <input id="btnAddFromTempTop" class="short-button" type="button" value="Thêm mới từ mẫu"
        ...
        <tr>
            <td>                
                    &nbsp;<igtbl:UltraWebGrid ID="grdSanPham" runat="server" Width="100%" DataKeyField="SanPhamID" OnPageIndexChanged="grdSanPham_PageIndexChanged">
                        <Bands>
                        ...
                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AutoGenerateColumns="False"
                            ...
                            <Pager PageSize="10" Pattern="Trang [default]" AllowCustomPaging="True" StyleMode="QuickPages" AllowPaging="True" QuickPages="10">
