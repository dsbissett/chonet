...
<script type="text/javascript">
    function Add(){                              
        OpenDialogWindow('Thêm khu vực',350,240,'page','AddRegion.aspx');    
    }

    function Edit(obj){   
            var cell=igtbl_getCellById(obj.parentElement.id);
            var id=cell.Row.getCellFromKey('KhuVucID').getValue();                   
            OpenDialogWindow('Sửa thông tin khu vực',350,240,'page','AddRegion.aspx?kid=' + id);// + '&rand=' + rand_no);    
    }
            ...
            <Bands>
                <igtbl:UltraGridBand DataKeyField="KhuVucID">
                    <Columns>
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="TenKhuVuc" Key="TenKhuVuc" Width="40%">
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="GhiChu" Key="GhiChu" Width="40%">
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="HienThi" Key="HienThi" Width="20%">
                            <Header Caption="Hiển thị">
