<%@ Page Language="C#" MasterPageFile="~/Adm/Admin.master" AutoEventWireup="true"
    CodeFile="HomeConfig.aspx.cs" Inherits="Admin_HomeConfig" Title="Cấu hình Trang chủ" %>
...
<%@ OutputCache Duration="30" VaryByParam="Common.LoaiNguoiDungID();*" %>
...
function RefreshProduct(pid)
{
    ...
    switch(pid)
    {
        ...
        break;
//        case 4: warp = ig$('<%=pnlSanPham04.ClientID%>');        		
//        break;
...
function ChangeProduct(pid)
{
    if(pid == 4)
    {
        ...
        OpenDialogWindow('Thay đổi sản phẩm',1006,600,'page','SelectProd.aspx?pid=' + pid + '&cid=' + cid);
    }
    else
    {
...
function ChangeCat()
{
    OpenDialogWindow('Thay đổi danh mục',680,420,'page','SelectCat.aspx');
}
...
{   
    __doPostBack('<%=pnlHoTro.ClientID%>','');        
    CloseDialogWindow();		
}
function AddHTTT(){                              
        OpenDialogWindow('Thêm hỗ trợ',340,280,'page','AddSupporter.aspx?sid=0');    
}
function EditHTTT(id){                              
        OpenDialogWindow('Sửa thông tin hỗ trợ',340,280,'page','AddSupporter.aspx?sid=0>&hid=' + id);    
}
                                                ...
                                                <div onclick="ChangeProduct(1);" style="cursor: hand;">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td class="red-button" style="width: 128px">
                                                                Thay đổi sản phẩm 01</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" width="207">
                                                    ...
                                                    <asp:UpdatePanel ID="pnlHoTro" runat="server" OnLoad="pnlHoTro_Load">
                                                        <ContentTemplate>
