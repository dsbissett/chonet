...
public partial class Admin_HomeConfig : Page
{
...
//            tblDanhMuc.Controls.Add(tbl);
    ...
    private void LoadSanPham04()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            if ((!Page.IsPostBack && i == 0) || hidCatId.Value == "0" || hidCatId.Value == "undefined")
            ...
            if (hidCatId.Value.Trim().Length > 0)
            {
                ...
                {
                    string content = "<a href=\"#Tab\" onclick=\"RefreshProduct04(" + dr[i]["NhomSanPhamID"] + ")\">" +
    ...
    protected void pnlHoTro_Load(object sender, EventArgs e)
    {
        LoadHoTroTrucTuyen();
    }
}