...
public partial class Admin_Cat2Config : Page
{
    ...
    private void LoadQuangCao23()
    {
        ...
        if (ds.Tables[0].Rows.Count >= 1)
        {
            ...
            {
                spnQuangCao23.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                          + "\" target=\"_blank\"><img alt=\"" + ds.Tables[0].Rows[0]["NoiDungQuangCao"]
                                          + "\" src=\"." + ds.Tables[0].Rows[0]["DuongDanAnh"] +
                                          "\" height=\"216px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/></a>";
            }
        }
        else
        {
            spnQuangCao23.InnerHtml =
