...
public partial class Adm_RegionHomeConfig : Page
{
    public int intKhuVucID = 7;

    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["rid"] != null)
        {
            intKhuVucID = int.Parse(Request.QueryString["rid"]);
        }
        if (Common.LoaiNguoiDungID() == 3)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    case 7:
                        Title = "Cấu hình khu vực Thái Nguyên";
                        break;
                    case 8:
                        Title = "Cấu hình khu vực Quảng Ninh";
                        break;
                    case 10:
                        Title = "Cấu hình khu vực Hải Phòng";
                        break;
                }
            }
        }
    ...
    private void LoadQuangCao01()
    {
        ...
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 1,
                                                                                  intKhuVucID);
        if (ds.Tables[0].Rows.Count >= 1)
        {
            ...
            else
            {
                spnQuangCao01.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                          ...
                                          "\" height=\"75px\" width=\"100%\" style=\"Border:none\"/></a>";
            }
        }
        else
        {
            spnQuangCao01.InnerHtml =
                "<img alt=\"Moi quang cao\" src=\"../images/advblank.jpg\" height=\"75px\" width=\"100%\" style=\"border:none\"/>";
        }
    }
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 2,
                                                                                  intKhuVucID);
        if (ds.Tables[0].Rows.Count >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
        ...
        else
        {
            spnQuangCao02.InnerHtml =
                "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"216px\" width=\"550px\" style=\"border:none\"/>";
        }
    }
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 3,
                                                                                  intKhuVucID);
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 4,
                                                                                  intKhuVucID);
        int n = 2;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 5,
                                                                                  intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 6,
                                                                                  intKhuVucID);
        int n = 5;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 7,
                                                                                  intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 8,
                                                                                  intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 9,
                                                                                  intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungIDAndKhuVuc(Common.LoaiNguoiDungID(), 10,
                                                                                  intKhuVucID);
        if (ds.Tables[0].Rows.Count >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            ...
            {
                spnQuangCao00.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                          + "\" target=\"_blank\"><img alt=\"" + ds.Tables[0].Rows[0]["NoiDungQuangCao"]
                                          + "\" src=\"." + ds.Tables[0].Rows[0]["DuongDanAnh"] +
                                          "\" height=\"75px\" width=\"100%\" style=\"Border:none\"/></a>";
            }
    ...
    private void LoadSanPham01()
    {
        ...
        DataSet ds = sp.SelectSanPhamAtViTriSanPhamByKhuVuc(1, intKhuVucID);
        int n = 20;
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            content1 += "<tr><td align=\"center\"><a href=\"productdetail.aspx?id=" + ds.Tables[0].Rows[i]["SanPhamID"]
                        + "\"><img src=\"." + ds.Tables[0].Rows[i]["AnhSanPham"]
                        + "\" width=\"99\" height=\"89\" border=\"0\" style=\"border:#CCCCCC 1px solid\" /></a></td>";
            content1 +=
                "<td align=\"Left\"><strong>SẢN PHẨM ĐÓN GIỜ VÀNG</strong><br /><a href=\"productdetail.aspx?id=" +
                ds.Tables[0].Rows[i]["SanPhamID"]
                + "\">" + ds.Tables[0].Rows[i]["TenSanPham"]
                + "</a><br />Giá: <span class=\"price\">" +
                String.Format("{0:0,0}", ds.Tables[0].Rows[i]["GiaSanPham"]).Replace(",", ".") + "</span>"
                + ds.Tables[0].Rows[i]["DonViTienTe"] + "</td></tr></table>";
    ...
    private void LoadSanPham02()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            if (i < n)
            {
                ...
                content += "<tr><td align=\"center\"><img src=\"." + ds.Tables[0].Rows[i]["AnhSanPham"]
                           + "\" width=\"99\" height=\"89\" border=\"0\" style=\"border:#CCCCCC 1px solid\" /></td>";
                content += "</tr><tr><td align=\"center\">" + ds.Tables[0].Rows[i]["TenSanPham"]
                           + "<br />Giá: <span class=\"price\">" +
    ...
    {
        SanPham sp = new SanPham();
        DataSet ds = sp.SelectSanPhamAtViTriSanPhamByKhuVuc(3, intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
        TableRow tr = new TableRow();
        for (int i = 0; i < 4; i++)
        {
            ...
            if (i < n)
            {
                ...
                content += "</tr><tr><td align=\"center\"><b>" + ds.Tables[0].Rows[i]["TenSanPham"] + "</b> <br />";
    ...
    private void LoadSanPham04()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (hidCatId.Value.Trim().Length > 0)
            {
                    ...
                    for (int j = 0; j < 2; j++)
                    {
                        ...
                        for (int si = 0; si < 6; si++)
                        {
                            ...
                            if (j*6 + si < sn)
                            {
                                ...
                                scontent += "<tr><td align=\"center\"><img src=\"." +
                                            sds.Tables[0].Rows[j*6 + si]["AnhSanPham"]
                                            +
                                            "\" alt=\"\" width=\"99\" height=\"89\" border=\"0\" style=\"border:#CCCCCC 1px solid\" /></td>";
                                scontent += "</tr><tr><td align=\"center\"><a href=\"\">" +
                ...
                {
                    string content = "<a href=\"#\" onclick=\"RefreshProduct04(" + dr[i]["NhomSanPhamID"] + ")\">" +
    ...
    {
        SanPham sp = new SanPham();
        DataSet ds = sp.SelectSanPhamAtViTriSanPhamByKhuVuc(5, intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
        for (int j = 0; j < 3; j++)
        {
            TableRow tr = new TableRow();
                    ...
                    if (GiaMoi != 0)
                    {
                        if (GiaMoi < GiaCu)
                        {
                            content +=
                                "<table class=\"product\" width=\"100%\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\">";
                            content += "<tr><td>";
                            content += "<img src=\"." + ds.Tables[0].Rows[j*4 + i]["AnhSanPham"]
                                       +
                                       "\" alt=\"\" width=\"74\" height=\"66\" border=\"0\" style=\"border:#CCCCCC 1px solid\" /></td>";
                            content += "<td style=\"width:60%\">" + ds.Tables[0].Rows[j*4 + i]["TenSanPham"]
                                       + "<br />Giá cũ: <span class=\"oldprice\">" +
                                       String.Format("{0:0,0}", GiaCu).Replace(",", ".")
                                       + "</span> " + ds.Tables[0].Rows[j*4 + i]["DonViTienTe"] + "<br/>";
                            content += "Giá mới: <span class=\"price\">" +
                                       String.Format("{0:0,0}", GiaMoi).Replace(",", ".")
    ...
    {
        SanPham sp = new SanPham();
        DataSet ds = sp.SelectSanPhamAtViTriSanPhamByKhuVuc(6, intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
        for (int j = 0; j < 3; j++)
        {
            TableRow tr = new TableRow();
            for (int i = 0; i < 2; i++)
            {
                ...
                if (j*2 + i < n)
                {
                    content +=
                        "<table class=\"product\" width=\"100%\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\">";
                    content += "<tr><td>";
                    content += "<img src=\"." + ds.Tables[0].Rows[j*2 + i]["AnhSanPham"]
                               +
                               "\" alt=\"\" width=\"74\" height=\"66\" border=\"0\" style=\"border:#CCCCCC 1px solid\" /></td>";
                    content += "<td style=\"width:60%\">" + ds.Tables[0].Rows[j*2 + i]["TenSanPham"]
                               + "<br />Giá: <span class=\"price\">" +
                               String.Format("{0:0,0}", ds.Tables[0].Rows[j*2 + i]["GiaSanPham"]).Replace(",", ".")
                               + "</span> " + ds.Tables[0].Rows[j*2 + i]["DonViTienTe"] + "</td></tr></table>";
                }
                td.Text = content;
                td.HorizontalAlign = HorizontalAlign.Left;
    ...
    {
        SanPham sp = new SanPham();
        DataSet ds = sp.SelectSanPhamAtViTriSanPhamByKhuVuc(7, intKhuVucID);
        int n = ds.Tables[0].Rows.Count;
        for (int j = 0; j < 3; j++)
        {
            TableRow tr = new TableRow();
    ...
    private void LoadGianHang()
    {
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                    content += "<table width=\"100%\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\">";
                    content += "<tr><td><img src=\"." + ds.Tables[0].Rows[j*4 + i]["Anh"] +
                               "\" width=\"110\" height=\"73\" style=\"border:#ece2a4 1px solid\" /></td>";
                    content += "<td><a href=\"#\"><b>" + ds.Tables[0].Rows[j*4 + i]["TenCuaHang"] +
                               "</b></a></td></tr></table>";
                }
                td.Text = content;
                td.HorizontalAlign = HorizontalAlign.Left;
