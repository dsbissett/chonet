...
namespace CHONET.DataAccessLayer.Web.BaseClasses
{
    public class Base_CuaHang
    {
        ...
        public int Insert(string TenCuaHang, string GioiThieu, int NguoiDungID, string Email, string Anh,
                          string DienThoaiDiDong, string DienThoaiCoDinh, string ThongTinLienHe, string DiaChi,
                          string Website, string Fax, string YM, bool KichHoat, int SapXep, string Bak1, string Bak2,
                          int Bak3, int Bak4, bool Bak5, string bak6, string bak7, string bak8, int Bak9, short BaoDam,
                          short LoaiCuaHang)
        {
            DataAccess objDataAccess = new DataAccess();
            using (SqlCommand sqlCmd = new SqlCommand())
        ...
        public void Update(int CuaHangID, string TenCuaHang, string GioiThieu, int NguoiDungID, string Email, string Anh,
                           string DienThoaiDiDong, string DienThoaiCoDinh, string ThongTinLienHe, string DiaChi,
                           string Website, string Fax, string YM, bool KichHoat, int SapXep, string Bak1, string Bak2,
                           int Bak3, int Bak4, bool Bak5, string bak6, string bak7, string bak8, int Bak9, short BaoDam,
                           short LoaiCuaHang)
        ...
        public int InsertFields(string TenCuaHang, string GioiThieu, int? NguoiDungID, string Email, string Anh,
                                string DienThoaiDiDong, string DienThoaiCoDinh, string ThongTinLienHe, string DiaChi,
                                string Website, string Fax, string YM, bool? KichHoat, int? SapXep, string Bak1,
                                string Bak2, int? Bak3, int? Bak4, bool? Bak5, string bak6, string bak7, string bak8,
                                int? Bak9, short? BaoDam, short? LoaiCuaHang)
        {
            DataAccess objDataAccess = new DataAccess();
            using (SqlCommand sqlCmd = new SqlCommand())
            {
        ...
        public void UpdateFields(int CuaHangID, string TenCuaHang, string GioiThieu, int? NguoiDungID, string Email,
                                 string Anh, string DienThoaiDiDong, string DienThoaiCoDinh, string ThongTinLienHe,
                                 string DiaChi, string Website, string Fax, string YM, bool? KichHoat, int? SapXep,
                                 string Bak1, string Bak2, int? Bak3, int? Bak4, bool? Bak5, string bak6, string bak7,
                                 string bak8, int? Bak9, short? BaoDam, short? LoaiCuaHang)
        {
            DataAccess objDataAccess = new DataAccess();
            using (SqlCommand sqlCmd = new SqlCommand())
            {
        ...
        public int CopyAndUpdateFields(int SourceID, string TenCuaHang, string GioiThieu, int? NguoiDungID, string Email,
                                       string Anh, string DienThoaiDiDong, string DienThoaiCoDinh, string ThongTinLienHe,
                                       string DiaChi, string Website, string Fax, string YM, bool? KichHoat, int? SapXep,
                                       string Bak1, string Bak2, int? Bak3, int? Bak4, bool? Bak5, string bak6,
                                       string bak7, string bak8, int? Bak9, short? BaoDam, short? LoaiCuaHang)
        {
            DataAccess objDataAccess = new DataAccess();
            using (SqlCommand sqlCmd = new SqlCommand())
            {
        ...
        public DataSet SelectByNguoiDungIDPaging(int NguoiDungID, int RowStart, int PageSize)
        {
            ...
            {
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandText = "GetCuaHangByNguoiDungIDPaging";
                sqlCmd.Parameters.Add("@NguoiDungID", SqlDbType.Int).Value = NguoiDungID;
