...
<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td>
    <igmisc:webasyncrefreshpanel id="pnlTinTuc" runat="server" Height="100%"  width="100%" OnContentRefresh="pnlTinTuc_ContentRefresh" RefreshComplete="WebAsyncRefreshPanel1_RefreshComplete"><igtbl:UltraWebGrid ID="grdTinTuc" runat="server" Width="100%" DataKeyField="TinTucID" OnInitializeLayout="grdTinTuc_InitializeLayout">
            <Bands>
                <igtbl:UltraGridBand DataKeyField="TinTucID">
                    <Columns>
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="TieuDe" Key="TieuDe" Width="45%">
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="TomTat" Key="TomTat" Width="55%">
                            <HeaderStyle HorizontalAlign="Center" />
