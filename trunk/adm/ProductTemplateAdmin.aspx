...
function Add(){                              
        OpenDialogWindow('Thêm sản phẩm',960,1225,'page','AddProductTemplate.aspx');    
}

function Edit(obj){   
        var cell=igtbl_getCellById(obj.parentElement.id);
        var id=cell.Row.getCellFromKey('SanPhamID').getValue();                   
        OpenDialogWindow('Sửa thông tin sản phẩm',960,1225,'page','AddProductTemplate.aspx?id=' + id);// + '&rand=' + rand_no);    
}
