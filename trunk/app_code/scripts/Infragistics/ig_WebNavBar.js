 /*
  * Infragistics WebNavBar CSOM Script: ig_WebNavBar.js
...
function igwnb_initialize(nBarId,tBarId,oPropArray,oEventArray,oItemArray,oTbPropArray,oTbEventArray)
{
	igtbar_initialize.apply(this,[tBarId,oTbPropArray,oItemArray,oTbEventArray]);
	try{eval("o"+tBarId+"=this;");}catch(xe){;}
	var props=(typeof(oPropArray)=="undefined") ? eval("igwnb_"+nBarId+"_Props") : oPropArray;
	this.nbId=nBarId;
	this.GridId=props[1];
	this.bScroll=props[2];
	this.insLoc=props[3];
    
	var events=(typeof(oEventArray)=="undefined") ? eval("igwnb_"+nBarId+"_Events") : oEventArray;
	...
	if((!ig_shared.IsIE) || (ig_shared.IsIE7))
		this.Element.style.height = "";	
	
	var items=(typeof(oItemArray)=="undefined") ? eval("igtbar_"+tBarId+"_Items") : oItemArray;
	if(items)
	{
	...
	try{eval("g"+tBarId+"IsLoaded=true;");}catch(xd){;}
