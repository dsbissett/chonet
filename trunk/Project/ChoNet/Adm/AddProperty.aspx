<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddProperty.aspx.cs" Inherits="Admin_AddProperty" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%; height:100%; text-align:center;vertical-align:middle;">
     ...
     <table style="text-align:left;">
        <tr>
             <td>
                 <asp:Label ID="Label3" runat="server" Text="Tên danh mục"></asp:Label></td>
             <td>
                 <asp:TextBox ID="txtDanhMucSanPham" runat="server" CssClass="textbox" Width="200px"></asp:TextBox></td>
         </tr>
        <tr>
             <td>
