<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Adm/Admin.master" CodeFile="CommentAdmin.aspx.cs" Inherits="Adm_CommentAdmin" Title="Quản lí Nhận xét sản phẩm" %>
            ...
            <Bands>
                <igtbl:UltraGridBand DataKeyField="NhanXetID">
                    <Columns>
                        ...
                        <igtbl:UltraGridColumn BaseColumnName="NhanXetID" DataType="System.Int32" Hidden="True"
                            Key="NhanXetID">
                            <Header>
