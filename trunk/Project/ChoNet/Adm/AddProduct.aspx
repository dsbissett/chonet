...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <table border="0" cellpadding="0" cellspacing="0" class="row-template-table" style="margin-top: 5px;
                        ...
                        <table width="100%" cellspacing="3px" style="text-align: left; vertical-align: top;
                            ...
                            <tr>
                                ...
                                <td style="width: 27%" valign="top">
                                    <asp:TextBox ID="txtTenPhu" runat="server" Width="266px"></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="height: 24px" valign="top">
                                    <igtxt:WebNumericEdit ID="txtGiaSanPham" runat="server" Width="98px" HorizontalAlign="Left">
                                    </igtxt:WebNumericEdit>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtGiaSanPham"
                                        ErrorMessage="*" Width="4%"></asp:RequiredFieldValidator>
                                    <asp:CheckBox ID="chkGiamGia" runat="server" Font-Bold="False" Text="Giảm giá" TextAlign="Left" />
                                    <igtxt:WebNumericEdit ID="txtGiaMoi" runat="server" Width="106px" HorizontalAlign="Left"
                                        Enabled="False">
                                    </igtxt:WebNumericEdit>
                            ...
                            <tr>
                                <td align="left" colspan="4" style="height: 30px">
                                    ...
                                    <asp:CompareValidator ID="cvGiaMoi" runat="server" ControlToCompare="txtGiaSanPham"
                                        ...
                                        Operator="LessThan" Type="Double" Enabled="False" SetFocusOnError="True"></asp:CompareValidator>
                            ...
                            <tr>
                                <td rowspan="1" align="right" valign="top" style="height: 82px; padding-right: 5px;">
                                    Ảnh chính(&lt;100Kb)</td>
                                <td colspan="2" valign="top" style="height: 82px">
                                    <asp:FileUpload ID="fileAnhChinh" runat="server" Width="96%" accept="image/*" />
                                    <asp:Label ID="lblAnhChinhErr" runat="server" ForeColor="Red"></asp:Label>&nbsp;<br />
                                ...
                                <td align="left" style="height: 82px" valign="top">
                                    ...
                                    <asp:UpdatePanel ID="pnlThuocTinh" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlThuocChinhCha" AutoPostBack="true" runat="server" Width="90%" OnSelectedIndexChanged="ddlThuocChinhCha_SelectedIndexChanged">
                                            </asp:DropDownList>
                ...
                <tr>
                    <td align="right" valign="top" style="width: 19%; padding-right: 5px;">
                        Mô tả sản phẩm&nbsp;</td>
