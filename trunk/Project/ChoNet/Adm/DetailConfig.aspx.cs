...
public partial class Adm_DetailConfig : Page
{
    ...
    private void LoadQuangCao42()
    {
        ...
        if (n >= 1)
        {
            ...
            {
                spnQuangCao42a.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
            ...
            if (n >= 2)
            {
                ...
                {
                    spnQuangCao42b.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[1]["DuongDan"]
                                               + "\" target=\"_blank\"><img alt=\"" +
                ...
                if (n >= 3)
                {
                    ...
                    {
                        spnQuangCao42c.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[2]["DuongDan"]
                                                   + "\" target=\"_blank\"><img alt=\"" +
