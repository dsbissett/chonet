...
public partial class _HaNoi : Page
{
        ...
        if (ds.Tables[0].Rows.Count >= 1)
        {
            ...
            else
            {
                spnQuangCao10.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                          ...
                                          "\" height=\"111px\" width=\"976px\" style=\"border:solid 1px #C9C3C3\"/></a>";
            }
        }
        else
        {
    ...
    private void LoadQuangCao03()
    {
        ...
        spnQuangCao03a.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        spnQuangCao03b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        //spnQuangCao03c.InnerHtml = "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
            ...
            else
            {
                spnQuangCao03a.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                           ...
                                           + "\" src=\"" + ds.Tables[0].Rows[0]["DuongDanAnh"] +
                                           "\" height=\"122px\" width=\"100%px\" style=\"border:solid 1px #C9C3C3\"/></a>";
            }
            if (n >= 2)
            {
                ...
                else
                {
                    spnQuangCao03b.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[1]["DuongDan"]
                                               ...
                                               "\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/></a>";
                }
                //if (n >= 3)
                //{
    ...
    private void LoadQuangCao05()
    {
        ...
        spnQuangCao05b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        //spnQuangCao05c.InnerHtml = "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
    ...
    private void LoadQuangCao07()
    {
        ...
        spnQuangCao07b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        //spnQuangCao07c.InnerHtml = "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
    ...
    private void LoadQuangCao08()
    {
        ...
        spnQuangCao08b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        //spnQuangCao08c.InnerHtml = "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
    ...
    private void LoadQuangCao09()
    {
        ...
        spnQuangCao09b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        //spnQuangCao09c.InnerHtml = "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"100%\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
