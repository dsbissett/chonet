...
public partial class _HaiPhong : Page
{
    private void Page_Init(Object sender, EventArgs e)
    {
        Master.clsHome = "menu";
        Master.clsHP = "menu_ac";
        Master.clsQN = "menu";
        Master.clsTN = "menu";
    }
        ...
        if (ds.Tables[0].Rows.Count >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            {
                spnQuangCao02.InnerHtml = "<object border:solid 1px #C9C3C3 classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\""
                                          ...
                                          + "width=\"596\" height=\"216\" title=\"Quang Cao\">"
                                          ...
                                          + "width=\"596\" height=\"216\"></embed></object>";
            }
            else
            {
                spnQuangCao02.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                          ...
                                          "\" height=\"216px\" width=\"596px\" style=\"border:solid 1px #C9C3C3\"/></a>";
            }
        }
        else
        {
    ...
    private void LoadQuangCao03()
    {
        ...
        spnQuangCao03a.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/>";
        spnQuangCao03b.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/>";
        spnQuangCao03c.InnerHtml =
            "<img alt=\"Moi quang cao\" src=\"./images/advblank.jpg\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/>";
        if (n >= 1)
        {
            if (ds.Tables[0].Rows[0]["LoaiAnh"].ToString() == "FLASH")
            ...
            else
            {
                spnQuangCao03a.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[0]["DuongDan"]
                                           ...
                                           + "\" src=\"" + ds.Tables[0].Rows[0]["DuongDanAnh"] +
                                           "\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/></a>";
            }
            if (n >= 2)
            {
                ...
                if (n >= 3)
                {
                    if (ds.Tables[0].Rows[2]["LoaiAnh"].ToString() == "FLASH")
                    {
                        spnQuangCao03c.InnerHtml = "<object style=\"border:solid 1px #C9C3C3\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\""
                                                   ...
                                                   ds.Tables[0].Rows[2]["DuongDanAnh"] + "\" />"
                                                   + "<param name=\"quality\" value=\"high\" />"
                                                   + "<embed src=\"" + ds.Tables[0].Rows[2]["DuongDanAnh"] +
                                                   "\" quality=\"high\""
                                                   +
                                                   "pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\""
                                                   + "width=\"312\" height=\"122\"></embed></object>";
                    ...
                    {
                        spnQuangCao03c.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[2]["DuongDan"]
                                                   + "\" target=\"_blank\"><img alt=\"" +
                                                   ds.Tables[0].Rows[2]["NoiDungQuangCao"]
                                                   + "\" src=\"" + ds.Tables[0].Rows[2]["DuongDanAnh"] +
                                                   "\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/></a>";
                    }
                }
            }
        ...
        if (n >= 1)
        {
            ...
            if (n >= 2)
            {
                ...
                if (n >= 3)
                {
                    ...
                    {
                        spnQuangCao05c.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[2]["DuongDan"]
                                                   + "\" target=\"_blank\"><img alt=\"" +
                                                   ds.Tables[0].Rows[2]["NoiDungQuangCao"]
                                                   + "\" src=\"" + ds.Tables[0].Rows[2]["DuongDanAnh"] +
                                                   "\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/></a>";
    ...
    {
        QuangCao qcao = new QuangCao();
        DataSet ds = qcao.SelectQuangCaoAtViTriQuangCaoByLoaiNguoiDungID(3, 6);
        int n = 5;
        ...
        if (n >= 1)
        {
            ...
            if (n >= 2)
            {
                ...
                if (n >= 3)
                {
                    ...
                    {
                        spnQuangCao07c.InnerHtml = "<a href=\"" + ds.Tables[0].Rows[2]["DuongDan"]
                                                   + "\" target=\"_blank\"><img alt=\"" +
                                                   ds.Tables[0].Rows[2]["NoiDungQuangCao"]
                                                   + "\" src=\"" + ds.Tables[0].Rows[2]["DuongDanAnh"] +
                                                   "\" height=\"122px\" width=\"312px\" style=\"border:solid 1px #C9C3C3\"/></a>";
    ...
    private void LoadSanPham01()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            string content1 = "<a href=\"productdetail.aspx?id=" + ds.Tables[0].Rows[i]["SanPhamID"]
                              ...
                              + "\" alt=\"" + ds.Tables[0].Rows[i]["TenSanPham"]
                              + "\" width=\"65\" height=\"62\" style=\"border:#CCCCCC 1px solid\" /></a>";
            string content2 = "<a href=\"productdetail.aspx?id=" + ds.Tables[0].Rows[i]["SanPhamID"] + "\">"
                              + ds.Tables[0].Rows[i]["TenSanPham"] + "</a>";
            td1.Text = content1;
            td2.Text = content2;
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (j*4 + i < n)
                {
                    ...
                    content += "Giá mới: <span class=\"price\">"
                               + String.Format("{0:0,0}", ds.Tables[0].Rows[j*4 + i]["GiaKhuyenMai"]).Replace(",", ".")
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (j*2 + i < n)
                {
                    ...
                    content += "<td style=\"width:60%\"><a href=\"productdetail.aspx?id=" +
                               ...
                               + "\">" + ds.Tables[0].Rows[j*2 + i]["TenSanPham"]
                               + "</a><br />Giá: <span class=\"price\">" +
